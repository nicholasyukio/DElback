...
interface CountSubscribersResponse {
    total: number;
}
interface ForgetSubscriberResponse {
    message: string;
    data: SubscriberObject;
}
...
interface CreateUpdateCampaignParams {
    name: string;
    language_id?: number;
...
interface ListAllSegmentsResponse {
...
interface ListAllTimezonesResponse {
...
interface ListAllLanguagesResponse {
...
interface WebhooksInterface {
    ...
    update: (webhook_id: string, params: UpdateWebhookParams) => Promise<AxiosResponse<SingleWebhookResponse, UpdateWebhookParams>>;
